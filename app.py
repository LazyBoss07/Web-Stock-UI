...
# API_KEY=pk_3eb0a1d6b21f468da0d712930549e542
    ...
    if request.method == "GET":
        ...
        try:
            if int(shares) < 0:
                ...
                return apology("Please enter a number of shares in +VE INTEGER.",400)
...
def quote():
    ...
    if request.method == "GET":
        ...
        return render_template("display.html", name=name, symbol=symbol.upper(), price=price)
